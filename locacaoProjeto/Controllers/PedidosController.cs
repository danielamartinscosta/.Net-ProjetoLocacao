...
namespace locacaoProjeto.Controllers
{
    public class PedidosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ClienteId,Carro,DataLocacao,DataEntrega")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClienteId,Carro,DataLocacao,DataEntrega")] Pedido pedido)
        {
            if (id != pedido.Id)
            {
                return NotFound();
